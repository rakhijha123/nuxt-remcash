   ...
   const leftScrollContent = reactive([
      {
         ...
         description:"Remcash provides a fully secure digital wallet to ease everyday transactions"
      },
      {
         img:PayBills,
         heading:"Instant money transfer",
         description:"Remcash provides fast, secure and instant money transfers across the globe"
      },
      {
         img:MoneyTransfer,
         heading:"Pay the bills easily",
         description:"With Remcash, paying bills is quick and easy, fully secure and convenient"
      }
   ]);
   const leftScrollContentPosition = ref(0);
   const leftScroll = () => {
      leftScrollContentPosition.value = (leftScrollContentPosition.value + 1) % leftScrollContent.length;
    };
   onMounted(() => {
       ...
       <div class="main_login">
        <div class="main_login_left">
          <div class="main_login_left-top">
            <img src={this.leftScrollContent[this.leftScrollContentPosition].img} alt="" />
          </div>
          
          <div class="main_login_left-bottom">
            <h2>{this.leftScrollContent[this.leftScrollContentPosition].heading}</h2>
            <p>
            {this.leftScrollContent[this.leftScrollContentPosition].description}
            </p>
          </div>
        </div>
